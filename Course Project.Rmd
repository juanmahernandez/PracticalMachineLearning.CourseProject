...
Comparing the accuracy of each model process, we see in the results that "rpart"" had a 58.7% of accuracy, where it's been the less
accurate of the models, having "linear discriminant analysis" with 57.3% and "random forest" with 100%.
